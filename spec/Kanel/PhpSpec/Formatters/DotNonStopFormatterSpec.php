...
namespace spec\Kanel\PhpSpec\Formatters;
...
class DotNonStopFormatterSpec extends ObjectBehavior
{
	function let(
		Presenter $presenter,
		ConsoleIO $io,
	...
	function it_outputs_the_progress_non_stop(
		...
		$suite->count()->willReturn(132);

		$stats->getEventsCount()->willReturn(132);

		$this->beforeSuite($suiteEvent);
		$this->afterExample($exampleEvent);

		$io->write(' 132 / 132')->shouldHaveBeenCalled();
	}
